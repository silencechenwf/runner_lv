...
<head>
    ...
    <script type="text/javascript" src="/static/js/jquery-1.4.4.min,LAB.min.js"></script>
        ...
        <div class="bottom_c h650">
            ...
            <div class="bottom_c_r">
                <h2 style="width:680px; height:40px; line-height:41px; background:#83bb4a url(../images/reg-title-bg.png) repeat-x;
                    ...
                    发起旅游</h2>
                <form id="form100" action="${ctx}/traveller/travelAdd" method="post" class="reg-form"
                      enctype="multipart/form-data">
                    <p><label for="title"><em>*</em>标题：</label>
                        <input name="title" type="text" class="input-txt" id="title" autocomplete="off" size="43"/>
                    </p>
                    <p><label for="place"><em>*</em>目的地：</label>
                        <input name="place" type="text" class="input-txt" id="place" autocomplete="off" size="43"/>
                    </p>
                    <p><label for="startTime"><em>*</em>起始日期：</label>
                        <input name="startTime" id="startTime" type="text" class="input-txt" autocomplete="off"
                               size="43" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                    </p>
                    <p><label for="returnTime"><em>*</em>返回日期：</label>
                        <input name="returnTime" id="returnTime" type="text" class="input-txt" autocomplete="off"
                               size="43" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                    </p>
                    <p><label for="contact"><em>*</em>联系方式：</label>
                        <input name="contact" type="text" class="input-txt" id="contact" autocomplete="off" size="43"/>
                    </p>
                    <p><label for="photoo"><em>*</em>景点图片：</label>
                        <input name="photoo" type="file" value="上传照片" class="input-txt" id="photoo" autocomplete="off"
                               size="43"/>
                    </p>
                    ...
                    <a href="javascript:void(0);" id="publish" class="reg-login">发布</a>
                </form>
            </div>
        </div>
    </div>
