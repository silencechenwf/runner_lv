...
<head >
    ...
    <!-- 合并jquery and $LAB -->
    <script type="text/javascript" src="js/jquery-1.4.4.min,LAB.min.js?t=201301111415"></script>
    <script type="text/javascript" src="js/html5.js?t=201301111415"></script>
</head>
...
<div id="container"  class="noXtips cf">
    <div class="main">
        <h2>操作成功</h2>
        <br /><br /><br />
        <pre>                  <font style="font-size:16px; font-family:'新宋体'">操作成功，3s后跳转，点击<a href="${ctx}/user/index"> 这里 </a>立即跳转</font></pre>
