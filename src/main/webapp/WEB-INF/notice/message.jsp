                ...
                <div class="loginInfo">
                    <ul class="login">
                        ...
                        <li style="float:right"><a
                                href="${ctx}/user/acccount_detail">${sessionScope.register.userName}</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        </li>
                    </ul>
                </div>
            </c:if>
    ...
    <div class="mainWrap wide-wrap fn-clear">
        <div class="main">
            ...
            <div id="comment" class="comment cnt-box fn-clear">
                <h2>站内信<span style="float:right"><a href="${ctx}/notice/message_send">发送站内信</a>&nbsp;&nbsp;</span></h2>
                <ul id="comment-list" class="comment-list">
                    <c:forEach var="messageList" items="${requestScope.messageList}">
                        <li class="fn-clear">
                            <div class="comment_headPic fn-left">
                                <a href="#"><img width="75" height="75" alt="${messageList.sender}" src="images/default.jpg"> </a>
                            </div>
                            <div class="comment_info fn-right">
                                <p>
                                    <a class="comment_user" href="#"> ${messageList.sender}</a>03月15日 23:54
                                    <label style="float:right"><a class="comment_user"
                                                                  href="${ctx}/notice/delete">删除</a></label>
                                    <label style="float:right"><a class="comment_user" href="${ctx}/notice/reply">回复</a></label>
                                </p>
