            ...
            <div class="bottom_c h650">
                ...
                <div class="bottom_c_r">
                    ...
                    <ul id="comment-list" class="comment-list">
                        <c:forEach var="trav" items="${requestScope.travellerList}">
                            <li class="fn-clear">
                                <div>
                                    <p>
                                        <a class="comment_user"
                                           href="${ctx}/traveller/traveller_detail?travelPartnerId=${trav.travelPartnerId}">【${trav.startTime}-${trav.returnTime}】${trav.place}行</a>
                                        <label style="float:right"><a class="comment_user"
                                                                      href="${ctx}/traveller/deleTraveller?travelPartnerId=${trav.travelPartnerId}">删除</a></label>
                                    </p>
                                    <div class="comment_box">
                                        <div class="comment_cnt">
                                            目的地：${trav.place}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            行程：${trav.startTime} 至 ${trav.returnTime}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            发布时间：${trav.time}
                                        </div>
                                    </div>
                                </div>
