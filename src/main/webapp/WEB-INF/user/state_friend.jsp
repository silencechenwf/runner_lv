        ...
        <div class="bottom_c h650">
            ...
            <div class="bottom_c_r">
                ...
                <ul id="comment-list" class="comment-list">
                    ...
                    <c:forEach var="list" items="${requestScope.friend_dynamicList}">
                    <li class="fn-clear">
                        <div >
                            <p>
                                <!--TODO评论功能未做-->
                                <a class="comment_user" href="javascript:void(0);"><img width="75" height="75" alt="${list.userName}" src="images/default.jpg">
                                    &nbsp;&nbsp;&nbsp;&nbsp;${list.userName}</a>
                                <label style="float:right">发表于 ${list.time}&nbsp;&nbsp;&nbsp;&nbsp;<a class="comment_user" href="javascript:void(0);">评论</a></label>
                            </p>
