...
<div class="header">
    ...
    <div id="container">
        <div class="mainWrap cf">
            ...
            <div class="ui-box cf">
                ...
                <div class="ui-title">
                    <h2 class="ui-title-cnt fn-left"><em>最新发布</em> (<font color="blue">${requestScope.size}</font>篇帖子)
                    </h2>
                </div>
                    ...
                    <c:forEach var="trav" items="${requestScope.travel_partnerList}">
                        <li>
                            <a target="_blank" href="#" class="gonglue_img fn-left">
                                <img src="${photoPath}/${trav.photo}"
                                     alt="【${trav.startTime}-${trav.returnTime}】${trav.place}行"
                                     width="130" height="130"/>
                            </a>
                            <div class="gonglue_info fn-left">
                                <h3><a target="_blank"
                                       href="${ctx}/traveller/traveller_detail?travelPartnerId=${trav.travelPartnerId}"
                                       title="${trav.title}">【${trav.startTime}-${trav.returnTime}】${trav.place}行</a>
                                </h3>
                                <p>&nbsp;&nbsp;目的地：${trav.place}</p>
                                <p>&nbsp;&nbsp;行程：${trav.startTime} 至 ${trav.returnTime}</p>
                                <p>&nbsp;&nbsp;发布者: <a target="_blank" href="#">${trav.userName}</a>&nbsp;&nbsp;&nbsp;&nbsp;发布时间：${trav.time}
                                </p>
                            </div>
                        </li>
                    </c:forEach>
                ...
                <div class="ui-title-subcnt fn-right">
                    <a target="_blank" href="${ctx}/traveller/traSearchMore">+查看更多</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="footer ">
        <div class="footerWrap fn-clear">
			...
			<a href="#">陈伟峰</a><a href="#"> 张梦</a><a href="#">邢飞</a><a href="#">李治龙</a>
			</span></p>
                <div class="sns">
