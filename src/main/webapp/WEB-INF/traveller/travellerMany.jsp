...
<div class="header">
    <div class="headWrap">
        <div class="headTop fn-clear">
            <h1 class="logo">
                <a href="${ctx}/index" title="驴友网" style="float: left;" >驴友网</a>
            </h1>
        ...
        <div class="navSearch">
            <form action="${ctx}/memory/memory_search" method="get" id="searchForm" target="_blank">
...
<div id="container">
    <div class="mainWrap cf">
        <div class="search-box">
            <div class="search-body">
                <ul class="search-tab">
                    ...
                    <li  >
                        <a href="${ctx}/traveller/inputSearch" id="time" >时间</a>
                    </li>
                </ul>
                <form method="post"  action="${ctx}/traveller/searchTra" id="f1" class="search-form" >
                    <input type="text" id="k2" name="place"  class=" input-search"  autocomplete="off">
        ...
        <div class="ui-box cf">
            ...
            <div class="ui-title">
                <h2 class="ui-title-cnt fn-left"><em>最新发布</em> (<font color="blue">${requestScope.size}</font>篇帖子)</h2>
            </div>
            ...
            <div class="ui-title-subcnt fn-right">
                <a target="_blank" href="javascript:void(0);" >+查看更多</a>
            </div>
        </div>
    </div>
</div>
