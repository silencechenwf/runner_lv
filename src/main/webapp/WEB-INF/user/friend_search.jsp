        ...
        <div class="bottom_c h650">
            ...
            <div class="bottom_c_r">
                <h2 style="width:680px; height:40px; line-height:41px; background:#83bb4a url(images/reg-title-bg.png) repeat-x;
						color:#fefefe; text-indent:25px; font-size:20px; font-family:\9ED1\4F53; font-weight:400;">搜索好友结果</h2>
                <ul id="comment-list" class="comment-list">
                    ...
                    <li class="fn-clear">
                        <div >
                            <p>
                                <a class="comment_user" href="javascript:void(0);"><img width="75" height="75" alt="${requestScope.friendInfo.userName}" src="${photoPath}/${requestScope.friendInfo.photo}">
                                    &nbsp;&nbsp;&nbsp;&nbsp;${requestScope.friendInfo.userName}</a>
                                <label style="float:right"><a class="comment_user" href="#">删除</a></label>
                            </p>
                            <div class="comment_box">
                                <div class="comment_cnt">
                                    性别：<c:if test="${requestScope.friendInfo.sex eq 'man'}">男</c:if><c:if test="${requestScope.friendInfo.sex eq 'woman'}">女</c:if>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    所在地：${requestScope.friendInfo.place}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    生日：${requestScope.friendInfo.birthday}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    QQ：${requestScope.friendInfo.qq}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    手机：${requestScope.friendInfo.phone}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
                    </li>
